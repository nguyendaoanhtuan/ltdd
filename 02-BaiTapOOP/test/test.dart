...
void main() {
  ...
  // Tạo điện thoại mẫu
  DienThoai dienThoai1 = DienThoai("DT01", "Samsung Galaxy S24", "Samsung", 15000, 20000, 50, true);
  DienThoai dienThoai2 = DienThoai("DT02", "iPhone 15", "Apple", 20000, 25000, 30, true);
